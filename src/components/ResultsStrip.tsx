...
export function ResultsStrip({ stats }: ResultsStripProps) {
  return (
    <section aria-label="Experience highlights" className="relative w-full overflow-hidden border-y border-slate-200 bg-white">
      ...
      <div className="relative w-full">
        <div className="grid grid-cols-2 md:grid-cols-4 border-y border-slate-200" role="list">
          {stats.map((stat, i) => (
            <div 
              key={i} 
              role="listitem"
